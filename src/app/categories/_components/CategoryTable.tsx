      ...
      <table className="w-full text-left border-collapse">
        <thead>
          <tr className="border-b border-divider bg-bg-secondary/10">
            ...
            <th className="p-4 text-caption font-bold text-text-secondary uppercase tracking-widest w-16">Resim</th>
          ...
          {categories.length === 0 ? (
            ...
            categories.map((c) => (
              <tr key={c.id} className={cn("group hover:bg-bg-secondary/30 transition-colors", !c.isActive && "bg-bg-secondary/10 text-opacity-40")}>
                ...
                <td className="p-4">
                  <div className="w-12 h-12 rounded-lg overflow-hidden bg-bg-secondary border border-divider flex items-center justify-center shrink-0">
                    {c.image ? (
                      <img src={c.image} alt={c.name} className="w-full h-full object-cover" />
                    ) : (
                      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="text-text-secondary opacity-20">
                ...
                <td className="p-4">
                  <div className="flex flex-col">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-mono font-medium text-text-secondary border border-divider px-1 rounded bg-bg-secondary/50">
